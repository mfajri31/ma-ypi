		...
		<div class="col-lg-12">
			<div class="box">
				<div class="box-header">
					<h4 class="pull-left">Edit Pengumuman</h4>
				...
				<div class="box-body">
					<form action="" method="post" enctype="multipart/form-data">
						...
						<div class="form-group">
							<label>Isi</label>
							<textarea name="isi" id="editor" class="form-control"><?= $pengumuman['isi']; ?></textarea>
							<?= form_error('isi'); ?>
						</div>
						<div class="form-group">
							<label>Foto</label> <br>
							<img src="<?= base_url('assets/img/pengumuman/'.$pengumuman['foto']); ?>" width="200">
