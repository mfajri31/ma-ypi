        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="<?= base_url('assets/img/profil/'.userLogin()['foto']); ?>" class="user-image" alt="User Image">
              <span class="hidden-xs"><?= userLogin()['nama'] ?></span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="<?= base_url('assets/img/profil/'.userLogin()['foto']); ?>" class="img-circle" alt="User Image">
